...
(	
	...
	(Set kmlFile (ChangeExtension (Get lasFile) ".kmz"))	
	...
	(DrawElevationColor (Get image) (Get map) 450d, 1.0d)	
	(DrawHillsideShade (Get image) (Get map) 45d 5d 0.7d, 0.5d)
	...
	(SaveToFile (Get image) (Get kmlFile))
)